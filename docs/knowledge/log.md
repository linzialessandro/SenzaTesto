...
* **Compliance (2026-08-02)**: EU AI Act Art. 50 — provenance machine-readable (`lib/provenance.py`, generator), SOP revisione umana, checklist, memo in `docs/compliance/`.
* **Compliance (2026-08-02, update)**: Postura conservativa — badge **IA** ripristinato (browse + practice); notice trasparenza in Info; sample review 20 esercizi documentata (`sample-review-2026-08-02.md`); SenzaTesto = deployer/BYOK, non provider DeepSeek; no chatbot on-site.
